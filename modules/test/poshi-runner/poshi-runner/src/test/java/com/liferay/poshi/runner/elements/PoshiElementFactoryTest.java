...
public class PoshiElementFactoryTest {
	...
	public void testPoshiToReadableToXML() throws Exception {
		...
		PoshiElement fromReadableSyntax = PoshiElementFactory.newPoshiElement(
			readableSyntax, null);

		Element fromReadableSyntaxElement = fromReadableSyntax.toXML();

		String fromReadableSyntaxElementString = Dom4JUtil.format(
			fromReadableSyntaxElement, false);
	...
	public void testPoshiToXML() throws Exception {
		...
		Element poshiDom4JElement = poshiElement.toXML();

		String poshiElementString = Dom4JUtil.format(poshiDom4JElement, false);
