...
public class MonitorSchedulerTest
	...
	public void testGetDueMonitors() {
		...
		testEquals(
			monitors, monitorScheduler.getDueMonitors(1000000L, monitors));

		monitorResultStore.store("a", _newMonitorResult(1000000L));

		testEquals(
			Collections.emptyList(),
			monitorScheduler.getDueMonitors(1899000L, monitors));
		testEquals(
			monitors, monitorScheduler.getDueMonitors(1900000L, monitors));
	}
