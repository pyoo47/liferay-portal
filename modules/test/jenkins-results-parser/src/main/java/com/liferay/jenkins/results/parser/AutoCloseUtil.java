...
public class AutoCloseUtil {
	...
	public static boolean autoCloseOnCriticalBatchFailures(
		...
		for (AutoCloseRule autoCloseRule : autoCloseRules) {
			...
			if (topLevelBuild instanceof SourceFormatBuild) {
				sb.append(" The reopened pull request will still be ");
				sb.append(" automatically closed if other critical batches or");
				sb.append(" tests fail, even if this comment is not removed.");
			}

			sb.append("</em></strong></p><pre>ci&#58;reopen</pre>");
