...
package com.liferay.jenkins.results.parser.vm.provisioner.amazon.rds;

/**
 * @author Kiyoshi Lee
 */
public class AuroraMySQLAmazonVMProvisioner extends RDSAmazonVMProvisioner {

	public AuroraMySQLAmazonVMProvisioner(
