 ...
 */
public class PortalTestSuiteUpstreamControllerWorkspace extends BaseWorkspace {

	protected PortalTestSuiteUpstreamControllerWorkspace(
	...
	protected PortalTestSuiteUpstreamControllerWorkspace(
		...
		if (portalBranchSHA != null) {
			portalWorkspaceGitRepository.setBranchSHA(portalBranchSHA);
		}
