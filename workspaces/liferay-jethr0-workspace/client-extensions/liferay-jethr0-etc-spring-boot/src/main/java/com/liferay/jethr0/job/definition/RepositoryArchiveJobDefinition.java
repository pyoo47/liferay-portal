...
import com.liferay.jethr0.job.definition.parameter.RepositoryNamesJobParameterDefinition;
 ...
 */
public class RepositoryArchiveJobDefinition extends BaseJobDefinition {
	...
	public Set<JobParameterDefinition> getJobParameterDefinitions() {
		...
		jobParameterDefinitions.add(
			new RepositoryNamesJobParameterDefinition());

		return jobParameterDefinitions;
	}

	protected RepositoryArchiveJobDefinition(JobEntity.Type jobEntityType) {
		super(jobEntityType);
	}
