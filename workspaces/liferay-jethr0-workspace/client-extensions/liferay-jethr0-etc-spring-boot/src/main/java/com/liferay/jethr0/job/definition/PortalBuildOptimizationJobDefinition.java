...
import com.liferay.jethr0.job.definition.parameter.PortalUpstreamBranchSHAJobParameterDefinition;
 ...
 */
public class PortalBuildOptimizationJobDefinition extends BaseJobDefinition {
	...
	public Set<JobParameterDefinition> getJobParameterDefinitions() {
		...
		jobParameterDefinitions.add(
			new PortalUpstreamBranchSHAJobParameterDefinition());

		return jobParameterDefinitions;
	}

	protected PortalBuildOptimizationJobDefinition(JobEntity.Type type) {
		super(type);
	}
