...
import com.liferay.jethr0.job.definition.parameter.MirrorsURLJobParameterDefinition;
 ...
 */
public class MirrorsLocalCachePropagatorJobDefinition
	...
	public Set<JobParameterDefinition> getJobParameterDefinitions() {
		...
		jobParameterDefinitions.add(new MirrorsURLJobParameterDefinition());

		return jobParameterDefinitions;
	}

	protected MirrorsLocalCachePropagatorJobDefinition(JobEntity.Type type) {
		super(type);
	}
