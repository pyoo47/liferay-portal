...
import com.liferay.jethr0.job.definition.parameter.ForwardForceJobParameterDefinition;
import com.liferay.jethr0.job.definition.parameter.ForwardReceiverUserNameJobParameterDefinition;
 ...
 */
public class ForwardPullRequestJobDefinition extends BaseJobDefinition {
	...
	public Set<JobParameterDefinition> getJobParameterDefinitions() {
		...
		jobParameterDefinitions.add(new ForwardForceJobParameterDefinition());
		jobParameterDefinitions.add(
			new ForwardReceiverUserNameJobParameterDefinition());
		jobParameterDefinitions.add(
	...
	protected ForwardPullRequestJobDefinition(JobEntity.Type type) {
		super(type);
	}
