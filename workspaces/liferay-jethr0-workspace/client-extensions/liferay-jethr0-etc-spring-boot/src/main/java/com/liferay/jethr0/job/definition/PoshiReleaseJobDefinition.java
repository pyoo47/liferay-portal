 ...
 */
public class PoshiReleaseJobDefinition extends BaseJobDefinition {
	...
	public Set<JobParameterDefinition> getJobParameterDefinitions() {
		...
		jobParameterDefinitions.add(
			new TestSuiteNameJobParameterDefinition("acceptance-functional"));

		return jobParameterDefinitions;
	}

	protected PoshiReleaseJobDefinition(JobEntity.Type jobEntityType) {
		super(jobEntityType);
	}
